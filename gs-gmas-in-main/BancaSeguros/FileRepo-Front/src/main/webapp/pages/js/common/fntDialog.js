...
function fQstBox(message, fnct, par1, par2, par3, par4, par5) {
	document.getElementById("lblQstBox").innerHTML = message;
	document.getElementById("hQstBoxFnc").value = fnct;
	document.getElementById("hQstBoxPr1").value = par1;
	document.getElementById("hQstBoxPr2").value = par2;
	document.getElementById("hQstBoxPr3").value = par3;
	document.getElementById("hQstBoxPr4").value = par4;
	document.getElementById("hQstBoxPr5").value = par5;
	dijit.byId("dlgQstBox").show();
}

function fQstBoxYes() {
	dijit.byId('dlgQstBox').onCancel();
	// Ejecutar funcion segun parametro
	switch (document.getElementById("hQstBoxFnc").value) {
	case "OBPSTO":
		fOBPSolTomDo();
		break;
	case "OBPSES":
		fOBPSolEstYes(document.getElementById("hQstBoxPr1").value, document
				.getElementById("hQstBoxPr2").value);
		break;
	case "OBPAFA":
		fOBPSolAddFasDo();
		break;
	case "ODBEST":
		fODBDBeSet(document.getElementById("hQstBoxPr1").value, document
				.getElementById("hQstBoxPr2").value, document
				.getElementById("hQstBoxPr3").value);
		break;
	case "ORTEST":
		fORTRCoSet(document.getElementById("hQstBoxPr1").value, document
				.getElementById("hQstBoxPr2").value, document
				.getElementById("hQstBoxPr3").value);
		break;
	case "OSIEST":
		fOSISinSet(document.getElementById("hQstBoxPr1").value, document
				.getElementById("hQstBoxPr2").value, document
				.getElementById("hQstBoxPr3").value);
		break;
	default:
