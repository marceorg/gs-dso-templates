...
import com.hsbc.hbar.bancaseg.model.constant.WASConstants;
...
public class UserValidationServiceImpl implements UserValidationService {
	...
	private AuthorizedUser validateUser(final String peopleSoft) {
		...
		try {
			...
			requestSvc.put("SystemId", "BSCONS_SEG");
			...
			JSONObject cObject = XML.toJSONObject(responseSvc.getJSONObject("Message").getJSONObject("Response")
					.getString("BusDataSeg"));
			String lastName = cObject.getJSONObject("BusDataSeg").getString("LastName");
			String firstName = cObject.getJSONObject("BusDataSeg").getString("FirstName");
			String rol = cObject.getJSONObject("BusDataSeg").getJSONObject("Mandates").getString("Name");
