...
public final class WASConstants {
	...
	// End Points (MW)
	public static final String ENDPOINT_SEGMAX = System.getProperty("insurance.ENDPOINT_MDW");
	public static final String ENDPOINT_SHARED_SERVICES = System.getProperty("insurance.ENDPOINT_SHA ");
	// Key OVNYL
