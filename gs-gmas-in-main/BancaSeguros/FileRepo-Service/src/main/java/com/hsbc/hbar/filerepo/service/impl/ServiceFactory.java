...
public class ServiceFactory {
	...
	public static ApplicationContext getContext() {
		if (ServiceFactory.context == null) {
			ServiceFactory.context = new ClassPathXmlApplicationContext(new String[] { "ApplicationContextFR.xml" });
		}
	...
	public static OperationService getOperationService() {
		return (OperationService) getContext().getBean("OperationService");
	}
	...
	public static BatchService getBatchService() {
		return (BatchService) getContext().getBean("BatchService");
	}
}
